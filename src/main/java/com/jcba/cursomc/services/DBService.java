...
import com.jcba.cursomc.domain.ItemPedido;
import com.jcba.cursomc.domain.Pagamento;
import com.jcba.cursomc.domain.PagamentoComBoleto;
import com.jcba.cursomc.domain.PagamentoComCartao;
import com.jcba.cursomc.domain.Pedido;
import com.jcba.cursomc.domain.Produto;
import com.jcba.cursomc.domain.enums.EstadoPagamento;
...
import com.jcba.cursomc.repositories.ItemPedidoRepository;
import com.jcba.cursomc.repositories.PagamentoRepository;
import com.jcba.cursomc.repositories.PedidoRepository;
import com.jcba.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "juliocesar.jcba@gmail.com", "11111111111",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("123123123", "321321321"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "julio.jcba@live.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883321", "34252625"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "323", "Apto 301", "Jardim", "60000", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Matos", "567", "Sala 500", "Centro", "60000", cli1, c2);
